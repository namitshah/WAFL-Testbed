...
class ModelLearningUtils:
    ...
    def __init__(
        ...
        np.random.seed(seed)
        random.seed(seed)
        model, criterion, postprocessors = build_wafl_models(self.args)
        ...
        if self.args.dataset_file == "coco_panoptic":
            ...
            self.base_ds = get_coco_api_from_dataset(coco_val)
        else:
        ...
        with open(self.csv_file_path, "w", newline="", encoding="utf-8") as f:
            writer = csv.writer(f)
            writer.writerow(["epoch", "train_mAP", "train_loss", "test_mAP", "test_loss"])
